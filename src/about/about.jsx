    ...
    <main className="container-fluid bg-secondary text-center">
      <div>
        <h2>What is Actordle?</h2>
            <p  class="about">We've all met that one person who knows way too much about movies -- but how much do they really know?
        ...
        <h2>How to Play</h2>
            <p  class="about">Each day, a new Actor/Actress will be chosen. Your job as an Actordler is to name as many movies that the
